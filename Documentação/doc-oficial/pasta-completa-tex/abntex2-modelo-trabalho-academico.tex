...
\begin{figure}[H]
	...
	\caption{Resultado do teste SSL Server Test da aplicação da Pousada Chalés de Água de Coco, realizado na plataforma SSL Labs~\cite{ssllabs_app_pousada}.}
