...
\begin{figure}[H]
	\centering
	\caption{Link para o documento do ProjectLibre}
...
\begin{figure}[H]
	\centering
	\caption{Link para o quadro Kanban no GitHub}
...
{\hypersetup{urlcolor=black}
	\begin{figure}[H]
		\centering
		\caption{Link para o repositório do sistema no GitHub}
