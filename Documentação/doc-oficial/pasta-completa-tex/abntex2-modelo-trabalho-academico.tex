...
\begin{quadro}[H]
	...
	\begin{tabular}{|>{\centering\arraybackslash}m{1.4cm}|>{\raggedright\arraybackslash}m{6.5cm}|>{\raggedright\arraybackslash}m{3.8cm}|>{\raggedright\arraybackslash}m{2.5cm}|}
		...
		4 & Criar Modelo Entidade-Relacionamento (MER) e Diagrama de Entidade-Relacionamento (DER)    & Modelagem de dados   & ALTA    \\ \hline
		5 & Criar Diagramas de Componentes e de Implantação & Arquitetura & ALTA  \\ \hline
		...
		11 & Implementar funcionalidades de {Check-in} e\textit {Check-out} &
		...
		13 & Documentar a configuração e o código desenvolvido &
...
\begin{quadro}[H]
	...
	\begin{tabular}{|c|p{6.5cm}|p{3.8cm}|c|}
		...
		15 & Criar funcionalidade para registrar comprovação de pagamento de reservas &	Gestão Financeira/Gestão de Reservas &
		BAIXA \\ \hline
		...
		20 & implementar envio de notificação (\textit {e-mail}) para hóspede após confirmação da reserva & Notificações &
		BAIXA \\ \hline
		21 & Implementar criptografia &	Autenticação e Segurança &
		BAIXA \\ \hline
		22 & Definir, executar e documentar plano de testes & Testes & MÉDIA \\ \hline
		23 & Realizar ajustes de segurança & Autenticação e Segurança
		& MÉDIA \\ \hline
		24 & Elaborar e executar o plano de implantação & Implantação & 
		MÉDIA \\ \hline
		25 & Treinamento da proprietária da pousada para uso da aplicação &	Implantação & MÉDIA \\ \hline
	\end{tabular}
	\fonte{Elaborado pelos autores.}
\end{quadro}
% 
