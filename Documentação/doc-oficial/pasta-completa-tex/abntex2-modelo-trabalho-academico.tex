...
\begin{tabular}{|>{\centering\arraybackslash}m{1.2cm}|>{\centering\arraybackslash}m{3cm}|>{\centering\arraybackslash}m{4.5cm}|>{\raggedright\arraybackslash}m{5.5cm}|}
		...
		1 & 25/03/2025 a 08/04/2025 & Planejamento Inicial do Projeto  & 
	  	Definir ferramentas, plataformas, \textit{frameworks} e hospedagem; levantar custos
	  	 \\
		\hline
		2 & 09/04/2025 a 22/04/2025 & Início da Modelagem do Sistema  &
		Levantamento de requisitos e definição do escopo do projeto
		3 & 23/04/2025 a 06/05/2025 & Término da Modelagem do Sistema &	Configuração dos ambientes de trabalho  e criação dos diagramas faltantes \\ \hline
...
\begin{quadro}[H]
	...
	\begin{tabular}{|>{\centering\arraybackslash}m{1.2cm}|>{\centering\arraybackslash}m{3cm}|>{\centering\arraybackslash}m{4.5cm}|>{\raggedright\arraybackslash}m{5.5cm}|}
		...
		7 & 12/08/2025 a 18/08/2025 & Autenticação e CRUDs financeiros básicos & Configuração de login/logout no Django, CRUD inicial de categorias e formas de pagamento. \\ \hline	
		8 & 27/08/2025 a 09/09/2025 & CRUDs financeiros avançados e testes de autenticação & - Criar funcionalidade de edição do cadastro de despesas. \newline - Criar funcionalidade de registro de comprovação de pagamento de reservas. \newline - Criar funcionalidade de filtragem de receita/despesa (data, categoria). \newline - Criar login e logout de usuário. \newline - Implementar autenticação/criptografia. \newline - Integrar novas funcionalidades ao MVP.\\ \hline	
	\end{tabular}
	\fonte{Elaborado pelos autores.}
\end{quadro}	
\begin{quadro}[H]
