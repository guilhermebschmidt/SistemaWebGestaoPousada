...
\begin{table}[H]
	...
	\begin{tabular}{|>{\RaggedRight\arraybackslash}c|c|c|c|}
		...
		\hline
		AWS & Hospedagem em Nuvem & R\$ 0,00 & R\$ 41,00/mês \\
		\hline
...
Para o cenário comercial, o Custo Estimado é composto essencialmente pelo serviço de hospedagem em nuvem, em específico do servidor EC2, projetado para um custo mensal de aproximadamente R\$ 41,00. Enquanto, a estratégia de negócio se apoia no uso de tecnologias de código aberto (Nginx, Gunicorn, Django, PostgreSQL) e certificados de segurança gratuitos da Let's Encrypt, que mantêm os custos de licenciamento zerados em ambos os cenários. 
% --------------------------------------------------%
...
\begin{table}[H]
	...
	\adjustbox{max width=\textwidth}{
		\begin{tabular}{|>{\RaggedRight\arraybackslash}p{5.5cm}|c|c|c|c|}
			...
			\hline
			\textbf{Total Mão de Obra}       & 5 & 3 & 22 & 330 \\
			\hline
		\end{tabular}
	}
	\fonte{Elaborado pelos autores.}
...
\begin{table}[H]
	...
	\adjustbox{max width=\textwidth}{
		\begin{tabular}{|l|r|r|r|}
			...
			\hline
			Estrutura& 924,70 & 3.698,80  & 8.322,30 \\
			\hline
			\textbf{Total} & 7.724,68 & 30.897,92 &  69.522,12\\
			\hline
		\end{tabular}
	}
	\fonte{Elaborado pelos autores.}
...
Dessa forma, Ao consolidar o investimento fixo em equipamentos com os custos recorrentes de estrutura e pessoal, o custo total estimado para a pousada parceira realizar o projeto ao longo de 9 meses é de R\$ 87.772,12.

%-----------------------------------------------------%
% TÓPICO DE PROPOSTA DE VIABILIDADE COMERCIAL
\begin{comment}
\subsection{Proposta de Viabilidade Comercial}
O levantamento de custos associados ao projeto demonstrou que o desenvolvimento de um sistema customizado possui um custo inicial e operacional significativo. O que torna o modelo de venda única inviável para uma única pousada de pequeno porte.

Este tópico propõe um cenário hipotético de viabilidade comercial a longo prazo, transformando o sistema em um produto de \textit{Software as Service} (SaaS). Com o objetivo de diluir o custo de desenvolvimento e manutenção entre múltiplos clientes, através de um modelo de assinatura mensal, tornando a solução acessível para o mercado de pequenas pousadas.
...
\begin{quadro}[H]
	...
	\begin{tabular}{|>{\centering\arraybackslash}m{1.2cm}|>{\centering\arraybackslash}m{3cm}|>{\centering\arraybackslash}m{3cm}|>{\raggedright\arraybackslash}m{7cm}|}
		...
		\\
		\hline 
		20 & 09/10/2025 - 15/10/2025   & mplementação de Relatórios e Dashboard & Criar view relatórios: ocupação (temporada, mensal, quarto). 
