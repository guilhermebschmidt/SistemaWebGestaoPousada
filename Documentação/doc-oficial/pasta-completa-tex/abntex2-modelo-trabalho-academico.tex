...
O Scrum, cujos pilares são a transparência, a inspeção e a adaptação, operacionaliza esses princípios por meio da definição de papéis específicos, da realização de eventos formais e do uso de artefatos próprios, tornando o ciclo de desenvolvimento iterativo e flexível. Diante disso, a equipe adaptou a metodologia de forma estratégica às condições do projeto, considerando prazos, recursos e estrutura disponíveis.
...
\begin{quadro}[H]
	...
	\begin{tabular}{|>{\raggedright\arraybackslash}m{3cm} 
		...
		Guilherme Akio & Engenheiro de Dados (DBA) & Time de Desenvolvimento & Implementar, administrar e otimizar o banco de dados da aplicação; Entregas de funcionalidades relcionadas ao gerenciamento e persistência de dados \\ \hline
		Guilherme Bittencourt & Documentador Técnico e Engenheiro de Software & Scrum Master & Criar e manter a documentação técnica; Definir e organizar a estrutura da aplicação; Facilitar e práticas Scrum \\ \hline
		Kelly Radchelle & Gerente de Projeto & Product Owner & Coordenar a equipe e gerenciar as atividades do projeto; Facilitar tomada de decisões e comunicação entre as partes interessadas; Acompanhamento do progresso das \textit{sprints}  \\ \hline
		Rafael Teixeira & Desenvolvedor Frontend &  Time de Desenvolvimento & Projetar e implementar interfaces da aplicação; Entregas de funcionalidades relacionadas à experiência do usuário.\\ \hline
		Ricardo Carriel & Desenvolvedor Backend &  Time de Desenvolvimento & Implementar lógica de negócio; Configurar e administrar o servidor; Entregas de funcionalidades relacionadas a lógica e integração do sistema \\ \hline
	\end{tabular}
	\fonte{Elaborado pelos autores.}
\end{quadro}
%---
...
As \textit{sprints} foram organizadas em períodos de quinze dias (duas semanas), intervalo em conformidade com o Guia do Scrum \cite{scrumguide}. Totalizando 13 semanas de trabalho. Essa definição considerou a atuação majoritariamente remota da equipe e o tempo diário individual limitado para o trabalho, circunstâncias que demandaram períodos mais extensos para a execução das tarefas. Além disso, a organização das tarefas dentro de cada \textit{sprint} levou em consideração as datas de entrega do MVP, da documentação técnica e do produto final do projeto.

Diante disso, os itens do \textit{Product Backlog} foram distribuídos de forma a cumprir um progresso gradual das atividades em 2 fases. Assim, na primeira fase, as primeiras \textit{sprints} focaram na modelagem do sistema e escolha das ferramentas e tecnologias de gestão e desenvolvimento. Para então, nas próximas \textit{sprints}, a equipe inicia tarefas relacionadas ao desenvolvimento do MVP e documentação do sistema. Enquanto que na segunda fase, a equipe focou em desenvolver as  funcionalidades faltantes, integrar com o MVP, realizar testes e revisão da documentação. Sendo que, as atividades de desenvolvimento foram distribuídas considerando: prioridade e relações de dependência. 
\\
%

\begin{quadro}[H]
	\caption{Sprints Backlog} 
	\label{sprints_backlog_1} 
	\begin{tabular}{|>{\centering\arraybackslash}m{1.2cm}|>{\centering\arraybackslash}m{2.5cm}|>{\raggedright\arraybackslash}m{4cm}|>{\raggedright\arraybackslash}m{6.3cm}|}
		\hline
		\textbf{Sprint} & \textbf{Período} & \textbf{Objetivo} & \textbf{Atividades} \\
		\hline	
		1 & 25/03/2025 a 08/04/2025 & Planejamento Inicial do Projeto  & 
		Definição de ferramentas, plataformas, \textit{frameworks} e hospedagem; levantar custos
		\\
		\hline
		2 & 09/04/2025 a 22/04/2025 & Início da Modelagem do Sistema  &	Levantamento de requisitos e definição do escopo do projeto 
		\\
		\hline
		3 & 23/04/2025 a 06/05/2025 & Término da Modelagem do Sistema &	Configuração dos ambientes de trabalho  e criação dos diagramas faltantes
		\\ \hline
		4 & 07/05/2025 a 20/05/2025 &  Inicio do desenvolvimento do MVP & Desenvolvimento das funcionalidades CRUD do módulo quarto
		\\ \hline	
		5 & 21/05/2025 a 03/06/2025 & Continuidade do desenvolvimento do MVP & Desenvolvimento das funcionalidades CRUD dos módulos de hóspedes e de reservas;\\ \hline
		6 & 04/06/2025 a 24/06/2025 & Revisão do Código e Estruturação do Plano de Testes & Criar estrutura inicial do plano de testes; Revisão e padronização do código\\ \hline	
		7 & 12/08/2025 a 18/08/2025 & Início do desenvolvimento do módulo financeiro & Configuração da autenticação e CRUDs financeiros básicos e avançados \\ \hline	
		8 & 27/08/2025 a 09/09/2025 & Continuidade no desenvolvimento do módulo financeiro & Aplicação de Regras Financeiras Avançadas  \\ \hline
		9 & 10/09/2025 a 23/09/2025 & Continuidade no desenvolvimento do módulo financeiro & Criação das interfaces dos CRUDs financeiros e implementação das funcionalidades de geração de relatórios\\ \hline
		10 & 24/09/2025 a 07/10/2025 & Testes gerais e Revisão do Código &
		Testes integrados e revisão do código completo \\ \hline
		12 & 22/10/2025 a 07/11/2025 & Deploy do Sistema & Correção de bugs e entrega final do sistema \\ \hline
	\end{tabular}
	\fonte{Elaborado pelos autores.}
\end{quadro}
% ---
